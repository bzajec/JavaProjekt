...
public class EditForm extends javax.swing.JFrame {
     ...
     */
    public EditForm() throws Exception{
        initComponents();
        configurePanels();
    }
    ...
    private void configurePanels() throws Exception{
        tpContent.add("Edit films", new EditFilmPanel());
        tpContent.add("Add director", new AddDirectorPanel());
        tpContent.add("Add actor", new AddActorPanel());
    }
}
